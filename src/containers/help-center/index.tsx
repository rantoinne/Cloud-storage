...
import { HELP_CENTER_URL } from '@env'
import styles from './styles'
import { translate } from '@i18n'
import { spacing } from '@theme'

export const HelpCenterScreen = observer(() => {
  ...
  return (
    <>
      <Header navigation={navigation} title={translate('profile:help_center')} />
      <Screen paddingHorizontal={spacing[4]}>
        <WebView
          style={styles.webView}
          source={{ uri: HELP_CENTER_URL }}
